...
1. Limit the number effective weights needed to store by having multiple connections share the same weight and fine-tune those shared weights. (As the following figure)
<p align="center">
